...
namespace fastJSON
{
    ...
    internal sealed class Reflection
    {
        ...
        internal static FieldInfo GetGetterBackingField(PropertyInfo autoProperty)
        {
            ...
            var byteCode = getMethod.GetMethodBody() != null ? getMethod.GetMethodBody().GetILAsByteArray() : new byte[0];
            int pos = 0;
            ...
            while (pos < byteCode.Length)
            {
                ...
                {
                    return getMethod.Module.ResolveMember(BitConverter.ToInt32(byteCode, pos), getMethod.DeclaringType != null ? getMethod.DeclaringType.GetGenericArguments() : null, null) as FieldInfo;
                }
